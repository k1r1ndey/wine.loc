...
switch ( $action ) {
	...
	<p style="display: inline">
		...
		<input type="text" name="user_login" id="user_login" class="input half-dima" value="<?php echo esc_attr( wp_unslash( $user_login ) ); ?>" size="20" autocapitalize="off" /></label>


		<label for="user_email"><?php _e( 'Email' ); ?><br />
		<input type="email" name="user_email" id="user_email" class="input half-dima" value="<?php echo esc_attr( wp_unslash( $user_email ) ); ?>" size="25" /></label>
		<input type="text" name="sirname"  class="input half-dima" value="" size="25" /></label>
	</p>
		<?php
		/**
